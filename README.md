...
This use case maintains a complete history of confirmed reservations using a list data structure. Each booking is stored for future reference, enabling cancellation tracking, customer support, and report generation. This ensures reliable audit trails and simplified access to historical booking information.